...
// 工作目录挪出安装目录：进程 cwd 会钉住所在目录（及其 PowerShell 子进程继承的 cwd），
// npm i -g 升级时 rename 包目录即 EBUSY——2026-09-26 一个手动 `node bridge.js`
// （-WorkingDirectory 设在安装目录）让 qika-update 装失败。本文件路径全走 __dirname，不依赖 cwd
